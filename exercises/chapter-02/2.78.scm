...
; objects have particular types.
;
; Modify the definitions of type-tag, contents, and attach-tag from 2.4.2 so
...
; should be represented simply as Scheme numbers rather than as pairs whose car
